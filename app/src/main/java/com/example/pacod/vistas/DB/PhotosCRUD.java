package com.example.pacod.vistas.DB;
...
import com.example.pacod.vistas.DB.DatabaseHelper.DataBaseHelper;
import com.example.pacod.vistas.DB.Modelo.Cursando;
import com.example.pacod.vistas.DB.Modelo.Materia;
import com.example.pacod.vistas.DB.Modelo.Photo;
import com.example.pacod.vistas.DB.Modelo.Usuario;

import java.util.ArrayList;

/**
 * Created by cocoy on 18/10/2017.
 */
...
public class PhotosCRUD {
    ...
    public void newPhoto(Photo photo) {
        ...
        ContentValues values = new ContentValues();
        values.put(Photo_Contract.Photos.ID_PHOTOS,photo.getPath());
    ...
    public ArrayList<Materia> getMaterias() {
        ...
        String []columnas = {
                ...
                Photo_Contract.Materia.DESCRIPCION
        };
    ...
    public void deleteCursando(int id) {
        //obtiene la BD en modo de escritura
        SQLiteDatabase sqLiteDatabase = helper.getWritableDatabase();

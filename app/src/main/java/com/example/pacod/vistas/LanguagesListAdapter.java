...
public class LanguagesListAdapter extends BaseAdapter{
    ...
    public LanguagesListAdapter(Courses courses, ArrayList<String> nombre,ArrayList<String>  fecha,ArrayList<String> horario) {
...
// TODO Auto-generated method stub
        ...
        holder.tv_nombre=(TextView) view.findViewById(R.id.tv_language);
        holder.tv_nombre.setText(result.get(position));

        holder.tv_horario=(TextView) view.findViewById(R.id.tv_language1);
        holder.tv_horario.setText(result2.get(position));

        holder.tv_fecha=(TextView) view.findViewById(R.id.tv_language2);
